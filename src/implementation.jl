...
function NFFTPlan(k::Matrix{T}, N::NTuple{D,Int}; dims::Union{Integer,UnitRange{Int64}}=1:D,
    ...
    FP = plan_fft!(tmpVec, dims_; num_threads=NFFT._use_threads[] ? Threads.nthreads() : 1, fftflags_...)
    BP = plan_bfft!(tmpVec, dims_; num_threads=NFFT._use_threads[] ? Threads.nthreads() : 1, fftflags_...)
